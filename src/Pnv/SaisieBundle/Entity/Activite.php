...
/**
 * Activite
 * Cette classe correspond à la table activite dans la BDD
 * Elle contient toutes les variables correspondant aux champs de la table et les méthodes permettant d'y accéder (= les accesseurs get et set)
 * Le projet étant construit avec les annotations Symfony, tous les renseignements nécesaires à Symfony pour que l'applis fonctionne se trouvent en en-tête de la classe, des variables et des méthodes préfixés de @
 * (= caractéristiques et contraintes des champs (nom, type ...), jointures 
 *
